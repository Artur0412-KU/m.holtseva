...
export default function Contact() {
  return (
    <div id='call' className='bg-[url(/src/assets/background/form.png)] bg-cover py-[62px] px-[194px] flex flex-col gap-[116px] items-center mb-[100px] rounded-[30px] [@media(max-width:1024px)]:px-[30px] [@media(max-width:1024px)]:bg-center [@media(max-width:1024px)]:py-[80px] [@media(max-width:500px)]:rounded-[30px]'>
